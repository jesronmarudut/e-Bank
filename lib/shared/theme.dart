...
Color blueColor = const Color(0xff304FFE);
Color yellowColor = const Color(0xffFDD835);
Color redColor = const Color(0xffD32F2F);
Color redColor2 = const Color(0xff65241F);
Color blackColor = const Color(0xff141414);
Color greyColor = const Color(0xff2A2A2A);
Color greyColor2 = const Color(0xff414141);
Color greyColor3 = const Color(0xff898989);
...
TextStyle greyTextStyle2 = GoogleFonts.poppins(color: greyColor2);
TextStyle greyTextStyle3 = GoogleFonts.poppins(color: greyColor3);
